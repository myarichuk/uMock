...
class BaseProfiler : public ICorProfilerCallback3
{
public:
// ICorProfilerCallback3 implementation
	STDMETHOD(QueryInterface)(REFIID riid, void **ppObj) PURE;
	ULONG STDMETHODCALLTYPE AddRef() PURE;
	ULONG STDMETHODCALLTYPE Release() PURE;
...
// end of ICorProfilerCallback3 implementation
};
